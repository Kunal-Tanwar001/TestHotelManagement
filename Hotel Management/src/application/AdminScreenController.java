...
public class AdminScreenController implements Initializable{
    ...
    @FXML
    void customerScreen(MouseEvent event) {
    ...
    @FXML
    void employeesScreen(MouseEvent event) {

    	Stage employeeScreen = new Stage();
		Parent root = null;
    ...
    @FXML
    void homeScreen(MouseEvent event) {
